            ...
            public struct Item: GraphQLSelectionSet {
              ...
              public struct Filter: GraphQLSelectionSet {
                ...
                public struct StepsFull: GraphQLSelectionSet {
                  ...
                  public init(id: GraphQLID, index: Int, type: String, settings: JSON, url: String? = nil, filterId: GraphQLID) {
                    self.init(unsafeResultMap: ["__typename": "EditorFilterStep", "id": id, "index": index, "type": type, "settings": settings, "url": url, "filterId": filterId])
                  }
...
public final class GetChallengeMetaQuery: GraphQLQuery {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct BaseChallenge: GraphQLSelectionSet {
      ...
      public init(titleLocalized: String, hasAttachedStickerPacks: Bool, appAttachedEditorTemplate: AppAttachedEditorTemplate? = nil) {
        self.init(unsafeResultMap: ["__typename": "BaseChallenge", "titleLocalized": titleLocalized, "hasAttachedStickerPacks": hasAttachedStickerPacks, "appAttachedEditorTemplate": appAttachedEditorTemplate.flatMap { (value: AppAttachedEditorTemplate) -> ResultMap in value.resultMap }])
      }
