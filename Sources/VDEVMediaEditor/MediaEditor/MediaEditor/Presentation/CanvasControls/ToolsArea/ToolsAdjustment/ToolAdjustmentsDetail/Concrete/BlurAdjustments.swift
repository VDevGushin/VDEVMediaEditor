...
struct BlurAdjustments: View {
    ...
    private func startState() {
        withAnimation(.interactiveSpring()) {
            value = item.adjustmentSettings?.blurRadius ?? filter.normal
        }
    }
