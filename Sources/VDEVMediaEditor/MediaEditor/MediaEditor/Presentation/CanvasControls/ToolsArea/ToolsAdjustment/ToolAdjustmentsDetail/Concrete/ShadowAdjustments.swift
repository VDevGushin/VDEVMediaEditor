...
struct ShadowAdjustments: View {
    ...
    private func startState() {
        withAnimation(.interactiveSpring()) {
            value = item.adjustmentSettings?.shadow ?? filter.normal
        }
    }
