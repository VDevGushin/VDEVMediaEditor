...
struct ContrastAdjustments: View {
    ...
    private func startState() {
        withAnimation(.interactiveSpring()) {
            value = item.adjustmentSettings?.contrast ?? filter.normal
        }
    }
