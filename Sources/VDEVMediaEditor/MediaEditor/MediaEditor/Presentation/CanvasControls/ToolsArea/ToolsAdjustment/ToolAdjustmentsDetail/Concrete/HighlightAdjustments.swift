...
struct HighlightAdjustments: View {
    ...
    private func startState() {
        withAnimation(.interactiveSpring()) {
            value = item.adjustmentSettings?.highlight ?? filter.normal
        }
    }
