//
//  MediaPickerSegmentControl.swift
//  
//
//  Created by Vladislav Gushin on 19.10.2023.
//

import SwiftUI

public struct MediaPickerSegmentControl<Option: Hashable & Identifiable,
                                           SelectionView: View,
                                           SegmentContent: View>: View {
...
extension MediaPickerSegmentControl {
        ...
        var body: some View {
            Button(action: action) {
                content
                    ...
                    .overlay (
                        firstLevelOverlayBlendMode.map {
                            content
                                .blendMode($0)
                    ...
                    .overlay(
                        highestLevelOverlayBlendMode.map {
                            content
                                .blendMode($0)
                                .accessibilityHidden(true)
                        }
...
extension MediaPickerSegmentControl.Segment {
...
public extension MediaPickerSegmentControl {
